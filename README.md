...
+ [Linkedin](https://www.linkedin.com/in/jorgon29/)
+ [E-mail](jorgono@proton.me)
...
| Categoría | Contenido |
|---|---|
| Lenguajes de programación | Python, Rust, Javascript |
| Frameworks/Librerías | Rocket, Egui, Dioxus, React, ExpressJS, NestJS, Numpy, Matplotlib, Seaborn, SFML |
| Herramientas/Entornos de desarrollo | VS Code y Nvim |
| Gestores de bases de datos | PostgreSQL y MongoDB |
| Control de versiones | Git y Github |
| Otros | Docker, Linux, APIs rest, Clonezilla|
